  ...
  <form wire:submit.prevent="update">
    ...
    <div class="flex justify-between mb-2">
      ...
      <div class="w-auto">
        ...
        <input wire:model="kelas" name="kelas" id="kelas" type="text" class="form-control form-control-sm py-1 rounded-lg w-full @error('kelas') is-invalid @enderror" placeholder="kelas" aria-label="First name">
        @error('kelas')
        <div class="invalid-feedback">{{ $message }}</div>
        @enderror
      </div>
